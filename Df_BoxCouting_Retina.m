...
imagen_gris = im2gray(imagen); % Convierte RGB a gris 
imagen_gris = im2double(imagen_gris); % Convierte imagen a tipo double [0,1]
...
figure;
% subplot(2,3,1); imshow(imagen_original, []); title('Imagen Original de la Retina');
% subplot(2,3,2); imshow(Green); title('Imagen Extracción Canal Verde');
